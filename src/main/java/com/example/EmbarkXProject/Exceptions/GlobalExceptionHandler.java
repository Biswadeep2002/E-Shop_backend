package com.example.EmbarkXProject.Exceptions;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(NotUniqueExcaption.class)
    public ResponseEntity<String> notUniqueException(NotUniqueExcaption e){
        String response = e.getMessage();
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
